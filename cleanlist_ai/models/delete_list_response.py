...
class DeleteListResponse(BaseModel):
    ...
    list_id: StrictStr = Field(description="Identifier of the deleted list.")
    deleted: StrictBool = Field(description="Always true on a successful delete.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["task_id", "timestamp_ms", "agent_instructions", "usage", "message", "list_id", "deleted"]
