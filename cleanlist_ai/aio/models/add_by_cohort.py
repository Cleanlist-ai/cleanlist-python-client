...
class AddByCohort(BaseModel):
    ...
    """ # noqa: E501
    task_id: StrictStr = Field(description="A cohort handle from a prior search_people / list_leads_in_list response. Materializes that cohort's entities into this list.")
    entity_ids: Optional[Annotated[List[StrictStr], Field(max_length=2000)]] = None
    idempotency_key: Optional[Annotated[str, Field(strict=True, max_length=128)]] = None
    __properties: ClassVar[List[str]] = ["task_id", "entity_ids", "idempotency_key"]
