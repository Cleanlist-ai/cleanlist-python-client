# cleanlist_ai.aio.PublicEnrichmentApi
...
from cleanlist_ai.aio.models.enrich_by_task_request import EnrichByTaskRequest
from cleanlist_ai.aio.models.enrich_by_task_response import EnrichByTaskResponse
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = cleanlist_ai.aio.PublicEnrichmentApi(api_client)
    enrich_by_task_request = cleanlist_ai.aio.EnrichByTaskRequest() # EnrichByTaskRequest | 

    try:
        # Enrich entities from a prior task
        api_response = await api_instance.enrich_by_task(enrich_by_task_request)
...
```python
import cleanlist_ai.aio
from cleanlist_ai.aio.models.enrich_company_request import EnrichCompanyRequest
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cleanlist_ai.aio.PublicEnrichmentApi(api_client)
    enrich_company_request = cleanlist_ai.aio.EnrichCompanyRequest() # EnrichCompanyRequest | 

    try:
        # Enrich a company
        api_response = await api_instance.enrich_company(enrich_company_request)
...
```python
import cleanlist_ai.aio
from cleanlist_ai.aio.models.enrich_list_request import EnrichListRequest
from cleanlist_ai.aio.models.enrich_list_response import EnrichListResponse
from cleanlist_ai.aio.rest import ApiException
from pprint import pprint
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cleanlist_ai.aio.PublicEnrichmentApi(api_client)
    enrich_list_request = cleanlist_ai.aio.EnrichListRequest() # EnrichListRequest | 

    try:
        # Enrich a whole lead list
        api_response = await api_instance.enrich_list(enrich_list_request)
...
from cleanlist_ai.aio.models.enrich_person_response import EnrichPersonResponse
from cleanlist_ai.aio.rest import ApiException
from pprint import pprint
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cleanlist_ai.aio.PublicEnrichmentApi(api_client)
    enrich_person_request = cleanlist_ai.aio.EnrichPersonRequest() # EnrichPersonRequest | 

    try:
        # Enrich a single person
        api_response = await api_instance.enrich_person(enrich_person_request)
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Poll an enrichment workflow
        api_response = await api_instance.enrichment_status(workflow_id)
