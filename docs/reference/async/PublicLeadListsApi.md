# cleanlist_ai.aio.PublicLeadListsApi
...
from cleanlist_ai.aio.models.body import Body
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = cleanlist_ai.aio.PublicLeadListsApi(api_client)
    list_id = 'list_id_example' # str | 
    body = cleanlist_ai.aio.Body() # Body | 

    try:
        # Add leads to a list
        api_response = await api_instance.add_leads_to_list(list_id, body)
...
```python
import cleanlist_ai.aio
from cleanlist_ai.aio.models.create_list_request import CreateListRequest
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = cleanlist_ai.aio.PublicLeadListsApi(api_client)
    create_list_request = cleanlist_ai.aio.CreateListRequest() # CreateListRequest | 

    try:
        # Create a lead list
        api_response = await api_instance.create_list(create_list_request)
...
from cleanlist_ai.aio.models.csv_import_response import CsvImportResponse
from cleanlist_ai.aio.rest import ApiException
from pprint import pprint
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = cleanlist_ai.aio.PublicLeadListsApi(api_client)
    list_id = 'list_id_example' # str | 
    csv_import_request = cleanlist_ai.aio.CsvImportRequest() # CsvImportRequest | 

    try:
        # Import leads from CSV
        api_response = await api_instance.csv_import(list_id, csv_import_request)
...
```python
import cleanlist_ai.aio
from cleanlist_ai.aio.models.delete_list_response import DeleteListResponse
from cleanlist_ai.aio.rest import ApiException
from pprint import pprint
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a lead list
        api_response = await api_instance.delete_list(list_id)
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a lead list
        api_response = await api_instance.get_list(list_id)
...
```python
import cleanlist_ai.aio
from cleanlist_ai.aio.models.leads_page_response import LeadsPageResponse
from cleanlist_ai.aio.rest import ApiException
from pprint import pprint
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # List leads in a list
        api_response = await api_instance.list_leads_in_list(list_id, limit=limit, cursor=cursor)
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    try:
        # List lead lists
        api_response = await api_instance.list_lists(folder_id=folder_id, limit=limit, cursor=cursor)
...
```python
import cleanlist_ai.aio
from cleanlist_ai.aio.models.remove_leads_request import RemoveLeadsRequest
from cleanlist_ai.aio.models.remove_leads_response import RemoveLeadsResponse
from cleanlist_ai.aio.rest import ApiException
from pprint import pprint
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = cleanlist_ai.aio.PublicLeadListsApi(api_client)
    list_id = 'list_id_example' # str | 
    remove_leads_request = cleanlist_ai.aio.RemoveLeadsRequest() # RemoveLeadsRequest | 

    try:
        # Remove leads from a list
        api_response = await api_instance.remove_leads_from_list(list_id, remove_leads_request)
...
async with cleanlist_ai.aio.ApiClient(configuration) as api_client:
    ...
    api_instance = cleanlist_ai.aio.PublicLeadListsApi(api_client)
    list_id = 'list_id_example' # str | 
    public_lead_list_update = cleanlist_ai.aio.PublicLeadListUpdate() # PublicLeadListUpdate | 

    try:
        # Update a lead list
        api_response = await api_instance.update_list(list_id, public_lead_list_update)
